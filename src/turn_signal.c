...
void turn_signal_update() {
    lv_obj_set_style_img_recolor(turn_left, get_dash()->blinker ? GREEN_ON : GREEN_OFF, 0);
    lv_obj_set_style_img_recolor(turn_right, get_dash()->blinker ? GREEN_ON : GREEN_OFF, 0);
